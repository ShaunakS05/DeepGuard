...
gt_indices = np.random.choice(*np.where(speakers == "real"), 10, replace=False) 
...
def returnAudioScores():
    if (scores[speakers == "fake"] > 0.84):
        return ["Not a DeepFake", scores[speakers == "fake"]]
    else:
